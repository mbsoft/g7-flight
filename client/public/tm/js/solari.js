...
var URL = "http://localhost:3000/solari-board-master/example/data.json"
...
function addSolariBoard(divSelector) {
    ...
    for (var add_rows = 0; add_rows < BOARD_ROWS; add_rows++) {
        ...
        $section.append('<li class=board-data id=row' + add_rows + '><ul><li class=time></li><li class=time2></li><li class=departure></li></li><li class=status><div class=iconbox><div class=status-icon></div></div></li><li class="track"></li><li class="rides"></li><li class=alert></li></ul></li>');
